...
void rbtree_testcase(int connfd) {
    ...
    snprintf(buf, sizeof(buf), "RSET Teacher%d King", connfd);
    testcase(connfd, buf, "OK\r\n", "SET-Teacher");

    snprintf(buf, sizeof(buf), "RGET Teacher%d", connfd);
    testcase(connfd, buf, "King\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "RMOD Teacher%d Darren", connfd);
    testcase(connfd, buf, "OK\r\n", "MOD-Teacher");

    snprintf(buf, sizeof(buf), "RGET Teacher%d", connfd);
    testcase(connfd, buf, "Darren\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "REXIST Teacher%d", connfd);
    testcase(connfd, buf, "EXIST\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "RDEL Teacher%d", connfd);
    testcase(connfd, buf, "OK\r\n", "DEL-Teacher");

    snprintf(buf, sizeof(buf), "RGET Teacher%d", connfd);
    testcase(connfd, buf, "NO EXIST\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "RMOD Teacher%d KING", connfd);
    testcase(connfd, buf, "NO EXIST\r\n", "MOD-Teacher");
...
void hash_testcase(int connfd) {
    ...
    snprintf(buf, sizeof(buf), "HSET Teacher%d King", connfd);
    testcase(connfd, buf, "OK\r\n", "SET-Teacher");

    snprintf(buf, sizeof(buf), "HGET Teacher%d", connfd);
    testcase(connfd, buf, "King\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "HMOD Teacher%d Darren", connfd);
    testcase(connfd, buf, "OK\r\n", "MOD-Teacher");

    snprintf(buf, sizeof(buf), "HGET Teacher%d", connfd);
    testcase(connfd, buf, "Darren\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "HEXIST Teacher%d", connfd);
    testcase(connfd, buf, "EXIST\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "HDEL Teacher%d", connfd);
    testcase(connfd, buf, "OK\r\n", "DEL-Teacher");

    snprintf(buf, sizeof(buf), "HGET Teacher%d", connfd);
    testcase(connfd, buf, "NO EXIST\r\n", "GET-Teacher");

    snprintf(buf, sizeof(buf), "HMOD Teacher%d KING", connfd);
    testcase(connfd, buf, "NO EXIST\r\n", "MOD-Teacher");
